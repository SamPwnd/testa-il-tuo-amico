export const QUESTIONS = [
    ...
    {
        questionID: 3,
        question: 'Quale di questi sport ti piace di più?',
        options: [
            {
                "text": "Calcio",
    ...
    {
        questionID: 7,
        question: 'In quale di queste epoche vorresti vivere almeno un giorno?',
        options: [
            {
                "text": "Impero Romano",
    ...
    {
        questionID: 8,
        question: 'Se potessi scegliere solo una meta, quale sceglieresti?',
        options: [
            {
                "text": "Parigi",
    ...
    {
        questionID: 9,
        question: 'Quale superpotere vorresti avere?',
        options: [
            {
                "text": "Invisibilità",
    ...
    {
        questionID: 12,
        question: 'Quale film ti piace di più',
        options: [
            {
                "text": "Star Wars",
    ...
    {
        questionID: 13,
        question: 'Qual è la tua parte della giornata preferita?',
        options: [
            {
                "text": "Mattina",
    ...
    {
        questionID: 16,
        question: 'Sei un tipo da gatto o da cane?',
        options: [
            {
                "text": "Cane",
                "imageUrl": "../src/assets/images/dog.webp"
    ...
    {
        questionID: 17,
        question: 'Quale serie TV ti piace di più?',
        options: [
            {
    ...
    {
        questionID: 18,
        question: 'Lamborghini o Ferrari',
        options: [
            {
                "text": "Lamborghini",
